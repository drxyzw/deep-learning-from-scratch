...
if __name__ == "__main__":
    ...
    network = MultiLayerNet(n_layers=n_layers,
                           ...
                           use_batch_norm=use_batch_norm, activation="ReLU", weight_decay=0.1)
    ...
    df_output.to_excel(f"./ch06/multi_learning_overfitting_batch_normalization_{batch_normalization}_weight_decay_{network.weight_decay}.xlsx", index=True)
