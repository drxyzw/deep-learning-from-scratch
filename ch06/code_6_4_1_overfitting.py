...
if __name__ == "__main__":
    ...
    #                        activation="ReLU")
    use_batch_norm = True
    network = MultiLayerNet(n_layers=7, # 5, # for overfitting experiment
    ...
    df_output.to_excel(f"./ch06/multi_learning_overfitting_batch_normalization_{batch_normalization}.xlsx", index=True)
